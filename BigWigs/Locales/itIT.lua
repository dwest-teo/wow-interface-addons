...
L["extremelyOutdated"] = "|cffff0000AVVISO:|r Il tuo Big Wigs è obsoleto di almeno 80 revisioni!! La versione che usi può avere bug, mancare di funzioni o timer completamente sballati. È CALDAMENTE raccomandato aggiornare il tutto."
...
L["severelyOutdated"] = "|cffff0000La tua versione di Big Wigs è vecchia di oltre 150 revisioni!! Vi suggeriamo CALDAMENTE di aggiornare l'addon per evitare che ci siano problemi con gli altri giocatori!|r"
