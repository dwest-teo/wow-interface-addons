...
L["extremelyOutdated"] = "|cffff0000WARNING:|r Ваш Big Wigs устарел более чем на 80 ревизий!! Ваша версия может содержать ошибки, отсутствующие возможности, или вообще неправильные таймеры. НАСТОЯТЕЛЬНО рекомендуется обновить."
...
L["severelyOutdated"] = "|cffff0000Ваш Big Wigs устарел более чем на 150 ревизий!! Мы НАСТОЯТЕЛЬНО рекомендуем вам обновиться, чтобы предотвратить проблемы синхронизации с другими игроками!|r"
