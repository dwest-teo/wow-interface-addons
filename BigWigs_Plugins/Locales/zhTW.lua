...
L["emphasizedCountdown"] = "強調倒數"
L["emphasizedCountdownSinkDescription"] = "以 Big Wigs 強調倒數訊息輸出此插件資訊。此訊息支持文字和顏色，同一時間只能顯示一條訊息。"
L["emphasizedMessages"] = "強調訊息"
L["emphasizedSinkDescription"] = "以 Big Wigs 強調訊息輸出此插件資訊。此訊息支持文字和顏色，同一時間只能顯示一條訊息。"
L["enable"] = "啟用"
L["enableStats"] = "啟用統計"
...
L["victoryMessageBigWigs"] = "顯示 Big Wigs 訊息"
L["victoryMessageBigWigsDesc"] = "Big Wigs 訊息是一條簡單的「首領已被擊敗」訊息。"
