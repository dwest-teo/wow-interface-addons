...
L["EncounterID List"] = [=[Boss-IDs der momentanen Erweiterung:
...
L["%s Alpha Animation"] = "%s Transparenzanimation"
L["Say"] = "Sagen"
L["%s Color Animation"] = "%s Farbanimation"
...
L["%s Translate Animation"] = "%s Verschiebungsanimation"
