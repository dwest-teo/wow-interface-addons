...
L["AUTO_RAID_PARTY_INSTANCE"] = "Automatique: Raid/Groupe/Instance" -- Needs review
...
L["CM_DESC"] = "Activez ce module pour mettre des marqueurs permanents sur les plaques des unités (Joueur et PNJ)" -- Needs review
...
L["OPT_HEADER_GLOBAL_ENEMY_HEALER_OPTIONS"] = "Réglages globaux des soigneurs ennemis" -- Needs review
L["OPT_HEADER_GLOBAL_FRIENDLY_HEALER_OPTIONS"] = "Réglages globaux des soigneurs alliés" -- Needs review
...
L["OPT_POST_ANNOUNCE_CHANNEL_DESC"] = "Décider où votre annonce sera postée" -- Needs review
...
L["OPT_PROTECT_HEALER_MINIMUM_DAMAGE_AMOUNT"] = "Seuil (|cffdd0000%u|r) de dégâts " -- Needs review
L["OPT_PROTECT_HEALER_MINIMUM_DAMAGE_AMOUNT_DESC"] = "Les soigneurs alliés attaquées ne seront détectés qu'une fois ce seuil de dégâts, basé sur un pourcentage de votre propre vie maximale, sera atteint." -- Needs review
...
L["DESCRIPTION"] = "Entdecke auf der Stelle diese verdammten Heiler und sorge dafür, dass sie Ihr Schicksal ereilt! (PVE und PVP)"
...
L["NPC"] = "NSC"
L["NPH"] = "Namensplakettenanker" -- Needs review
...
L["OPT_CM_VCa"] = "Schattierungstransparenz"
-- L["OPT_CM_VCa_DESC"] = ""
L["OPT_CM_VCb"] = "Blaue Schattierung"
L["OPT_CM_VCb_DESC"] = "Ändert die Schattierung der blauen Komponente der Textur"
L["OPT_CM_VCg"] = "Grüne Schattierung"
L["OPT_CM_VCg_DESC"] = "Ändert die Schattierung der grünen Komponente der Textur"
L["OPT_CM_VCr"] = "Rote Schattierung"
L["OPT_CM_VCr_DESC"] = "Ändert die Schattierung der roten Komponente der Textur"
...
L["OPT_NPH_WARNING1"] = [=[WARNUNG: Die Namensplaketten feindlicher Einheiten sind deaktiviert. So kann HHTD sein Symbol nicht anzeigen.
Du kannst die Namensplaketten aktivieren über Interface > Spiel > Namen oder durch Drücken der zugewiesenen Taste(nkombination).]=]
L["OPT_NPH_WARNING2"] = [=[WARNUNG: Die Namensplaketten befreundeter Einheiten sind deaktiviert. So kann HHTD sein Symbol nicht anzeigen.
Du kannst die Namensplaketten aktivieren über Interface > Spiel > Namen oder durch Drücken der zugewiesenen Taste(nkombination).]=]
L["OPT_OFF"] = "aus"
...
L["OPT_STRICTGUIDPVE_DESC"] = "Bei namensgleichen NPCs wird HHTD nur solchen NPCs ein rotes Kreuz hinzufügen, welche auch tatsächlich geheilt haben und nicht allen. Denke daran, dass Du meistens den NPC im Ziel haben oder mit der Maus darüber fahren musst, damit das Kreuz erscheint."
...
L["OPT_HEALER_UNDER_ATTACK_ALERTS_DESC"] = "当附近的友方治疗职业被攻击时显示警报" -- Needs review
L["OPT_LOG"] = "正在记录"
...
L["CM"] = "自訂標記"
L["CM_DESC"] = "啟用此模組以設定NPC與玩家單位姓名條的永久定義標記。"
L["DESCRIPTION"] = "讓那些強大的補師立馬現形，並且幫助他們完成自己的使命! (PVP 和 PVE)"
L["DISABLED"] = [=[hhtd 已被禁用！
輸入“/hhtd on”來重新啟用。]=]
...
L["NPC"] = "NPC"
L["NPH"] = "名條標記"
L["NPH_DESC"] = "此模組在敵方治療者名條上添加一個紅十字"
L["OPT_ANNOUNCE"] = "顯示訊息"
...
L["OPT_STRICTGUIDPVE_DESC"] = "當幾個NPC共享相同的名稱時，HHTD將只會增加一個紅十字在真實的治療者上，而不是所有人。請注意大多數時間，你需要指定目標或滑鼠停留一個單位以便讓十字顯示。"
...
L["OPT_HEALER_UNDER_ATTACK_ALERTS_DESC"] = "выдать сообщение когда рядом с вами атакован наш лекарь " -- Needs review
L["OPT_LOG"] = "Загрузка"
...
L["OPT_POST_ANNOUNCE_CHANNEL_DESC"] = "выберите в каком канале появится ваше сообщение" -- Needs review
...
L["AUTO_RAID_PARTY_INSTANCE"] = "Auto: Raid/Party/Instance" -- Needs review
...
L["OPT_HEALER_UNDER_ATTACK_ALERTS_DESC"] = "Mostra un avviso quando un curatore amico è sotto attacco" -- Needs review
L["OPT_LOG"] = "Logging"
...
L["OPT_POST_ANNOUNCE_CHANNEL_DESC"] = "Decidi in quale canale inviare i tuoi annunci" -- Needs review
