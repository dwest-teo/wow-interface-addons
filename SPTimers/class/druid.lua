local addon, C = ...
local local_class ,class = UnitClass("player")
...
--	[2637]		= { duration = 40, pvpduration = 8 },
	...
	[8921]  	= { spec = ALL,duration = 40, pvpduration = 24, cleu = true, pandemia = true, color = colors.PURPLE, tick = 2, haste = true },
	[93402] 	= { spec = "1",duration = 20, cleu = true, pandemia = true, color = colors.ORANGE, tick = 2, haste = true },
	...
	[155625] 	= { spec = "2",duration = 14, tick = 2, haste = true, pandemia = true, color = colors.PURPLE,},
	
	
--	[9005] 		= { duration = 4, color = colors.PINK },
--	[9007] 		= { color = colors.RED, duration = 18, cleu = true },

	[1822] 		= { spec = "2",duration = 15, tick = 3, color = colors.LRED, cleu = true, pandemia = true },
	[155722] 	= { spec = "2",duration = 15, tick = 3, color = colors.LRED, cleu = true, pandemia = true },
	
	
	[1079] 		= { spec = "2",duration = 24, tick = 2, color = colors.RED, cleu = true, pandemia = true },
...
--	[127538] 	= { color = colors.PURPLE, duration = 12 },
	...
	[164812]	= { spec = "1",duration = 20, tick = 2, pandemia = true, cleu = true, haste = true, color = colors.PURPLE },
...
--	[106922] 	= { spec = ALL,group = "player", duration = 20, color = colors.BLACK },
	...
	[77758]  	= { spec = "3",duration = 16, tick = 2, color = colors.LBLUE },
	[106830]	= { spec = "2",duration = 16, tick = 3, color = colors.LBLUE, pandemia = true },
...
--	[102795] 	= { duration = 3, color = colors.RED },
	...
	[774]		= { spec = ALL,source = 2, group = "player", cleu = true, duration = 12, color = colors.REJUV, tick =3 , pandemia = true },
...
--	[145151]	= { color = colors.ELV_RAGE, }, -- cleu = true, whitelist_cleu = 2, duration = 30},
	...
	[164815]	= { spec = "1",duration = 24, cleu = true, pandemia = true, tick = 2, haste = true, color = colors.ORANGE },
...
function C:SetupClassOptions()
	...
	self.options.args.bars.args[class] = {
		type = "group",
		name = L["DRUID totem1"],
		order = order,
		embend = false,
	...
	for i=1, 3 do
		...
		self.options.args.bars.args[class].args["headertotem"..i] = {
			type = "group",
			name = L[class.." totem1"],
			order = order+1*i, args = {}, embend = true,
			}
			
		self.options.args.bars.args[class].args["headertotem"..i].args["showtotem"..i] = {
		...
		self.options.args.bars.args[class].args["headertotem"..i].args["colortotem"..i] = {
		...
		self.options.args.bars.args[class].args["headertotem"..i].args["prioritytotem"..i] = {
				name = L["Priority"],
				type = "slider",
				order	= order+(4*i),
				min		= -20,
		...
		self.options.args.bars.args[class].args["headertotem"..i].args["anchortotem"..i] = {
		...
		self.options.args.bars.args[class].args["headertotem"..i].args["grouptotem"..i] = {
				name = L["Select group"],
				order = order+(6*i),
