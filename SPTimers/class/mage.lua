...
--	[11113] = { color = colors.CHILL, duration = 3, cleu = true }, -- ?????
	...
	[2120]  = { spec = "2",duration = 8, haste = true, tick = 2, color = colors.ORANGE, cleu = true, group = "player", whitelist_cleu = 5, blacklist_cleu = 3, blacklist = 3 },
...
--	[116257] = { duration = 60, color = colors.DPURPLE },
	...
	[112948] = { spec = '3',duration = 4,  haste = true, tick = 4, color = colors.CURSE, cleu = true },
	[114923] = { spec = '1',custom_text = "%tN", duration = 12, haste = true, tick = 1, color = colors.PURPLE, cleu = true },
	[44457]  = { spec = '2',custom_text = "%tN", duration = 12, haste = true, tick = 3, color = colors.RED, cleu = true, pandemia = true },
	[11366]  = { spec = "2",duration = 18, haste = true, tick = 3, color = colors.RED, cleu = true, pandemia = true },
	[12654]  = { spec = "2",duration = 4,  tick = 2, color = colors.RED },
