...
--	[76780] = { duration = 50, pvpduration = 8, color = colors.PINK, cleu = true  },
	...
	[16166] = { spec = ALL,duration = 30, color = colors.CURSE },
	...
	[51533] = { spec = "2", duration = 30, cleu = true, group = "player", color = colors.DBLUE, whitelist_cleu = 5, },
...
function C:SetupClassOptions()
	...
	self.options.args.bars.args.Shaman = {
			type = "group",
			name = "|c"..RAID_CLASS_COLORS[class].colorStr..local_class,
	...
	for i=1, MAX_TOTEMS do
		...
		self.options.args.bars.args.Shaman.args["groupTotem"..i] = {
			type = "group",
			name = GetSpellNameGUI(totems[i])..L["SHAMAN totem"..i] ,
