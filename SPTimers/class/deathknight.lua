...
local spells = { 
	...
	[55095] = { spec = ALL,color = colors.CHILL, duration = 30, pandemia = true, tick = 3 },
	[55078] = { spec = ALL,color = colors.PURPLE, duration = 30, pandemia = true, tick = 3 },
...
function C:SetupClassOptions()
	...
	self.options.args.coolline.args.DKrunes = {
		type = "group",
		name = "|c"..RAID_CLASS_COLORS[class].colorStr.. L["Runes"],
