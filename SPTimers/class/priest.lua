...
local spells = {
	...
	[34914]	 = { spec = "3", pandemia = true, duration = 15, custom_text = "%tN", tick = 3, cast = 1.5, haste = true, cleu = true, color = colors.BLUE }, -- vt
	[589]	 = { spec = ALL, pandemia = true, duration = 18, custom_text = "%tN", tick = 3, haste = true, cleu = true, color = colors.PURPLE },	   -- swp
	...
	[15407]	 = { spec = "3", duration = 3, tick = 1, group = "target", channel = true, haste = true, },
	[129197] = { spec = "3", duration = 3, tick = 1, group = "target", channel = true, haste = true, },
