...
customColorPickerColor0255:SetFont(STANDARD_TEXT_FONT, 10)
...
customColorPickerColor01:SetFont(STANDARD_TEXT_FONT, 10)
...
customColorPickerRed:SetFont(STANDARD_TEXT_FONT, 12)
...
customColorPickerGreen:SetFont(STANDARD_TEXT_FONT, 12)
...
customColorPickerBlue:SetFont(STANDARD_TEXT_FONT, 12)
...
customColorPickerHex:SetFont(STANDARD_TEXT_FONT, 12)
...
alphaScrollText:SetFont(STANDARD_TEXT_FONT, 12)
...
alphaScroll._plus.text:SetFont(STANDARD_TEXT_FONT, 14, "OUTLINE")
...
alphaScroll._minus.text:SetFont(STANDARD_TEXT_FONT, 14, "OUTLINE")
